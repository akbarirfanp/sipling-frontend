...
useHead({ title: 'SIPLING - Dashboard' })
...
<template>
  <div class="space-y-6 p-6">
    <!-- Header -->
    <div>
      <h1 class="text-xl font-semibold text-gray-900">Ringkasan Data</h1>
    </div>
        ...
        <CnCardContent class="p-5">
          <div class="flex items-start justify-between">
            <div class="space-y-1">
              ...
              <p
                class="text-2xl font-bold text-black-500 transition-all duration-500"
